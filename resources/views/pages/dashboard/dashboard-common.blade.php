                ...
                <ul class="nav navbar-nav c-theme-nav">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu c-menu-type-mega c-visible-mobile">
                            <li class="dropdown-submenu">
                                <a href="javascript:;">letshomestudy.com Components
                                    <span class="c-arrow c-toggler"></span>
                                </a>
...
<div class="c-layout-page">
    ...
    <section class="c-layout-revo-slider c-layout-revo-slider-7">
        <div class="tp-banner-container tp-fullscreen tp-fullscreen-mobile">
            <div class="c-singup-form">
                <h3 class="c-font-54 c-font-thin c-font-white c-margin-b-40 c-font-uppercase"> The Ever Growing
                    <span class="c-theme-font c-font-bold">IGCSE </span> Tution Portal</h3>
                ...
                <form class="form-inline" action="#">
                    <div class="form-group">
                        <input type="text" class="form-control c-bg-transparent input-lg c-theme c-square " placeholder="Your name"> </div>
                    <div class="form-group">
                        <input type="email" class="form-control c-bg-transparent input-lg c-theme c-square " placeholder="Email address"> </div>
            ...
            <div class="row">
                    ...
                    <div class="c-content-step-1 c-opt-1">
                        <div class="c-icon">
                                    <span class="c-hr c-hr-first">
                                        <span class="c-content-line-icon c-icon-screen-chart"></span>
                                    </span>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 wow animate fadeInLeft" data-wow-delay="0.2s">
                    <div class="c-content-step-1 c-opt-1">
                        <div class="c-icon">
                                    <span class="c-hr">
                                        <span class="c-content-line-icon  c-icon-globe"></span>
                                    </span>
                        </div>
                    ...
                    <div class="c-content-step-1 c-opt-1">
                        <div class="c-icon">
                                    <span class="c-hr c-hr-last">
                                        <span class="c-content-line-icon c-icon-bulb"></span>
                                    </span>
                        </div>
    ...
    <div class="c-content-box c-size-lg c-bg-red">
        <div class="container">
            <div class="row">
                <div class="c-shop-banner-3 c-center">
                    <h3 class="c-title c-font-uppercase c-font-bold c-font-35 c-font-white">Excited Launching Offer</h3>
            ...
            <div class="c-content-counter-1">
                ...
                <div class="row c-margin-t-60">
                    <div class="col-md-4">
                        ...
                        <h4 class="c-title c-first c-font-white c-font-uppercase c-font-bold">Current Courses</h4>
                        <p class="c-content c-font-white c-opacity-08">..and growing. We will never stop improving and updating letshomestudy.com. Expect more.</p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="c-title c-font-white c-font-uppercase c-font-bold">Total Sold Courses</h4>
                            ...
                            <div class="tab-pane fade in active" id="c-tab3-1">
                                <div class="col-md-5 col-sm-12">
                                    <ul class="c-items">
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-connectdevelop"></i>letshomestudy.com Framework</h4>
                            ...
                            <div class="tab-pane fade" id="c-tab3-2">
                                <div class="col-md-5 col-sm-12">
                                    <ul class="c-items">
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-file-code-o"></i>UX Conference 2017</h4>
                                        ...
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-dropbox"></i>Cloud Storage</h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                    </ul>
                                    <button class="btn btn-lg c-theme-btn c-btn-square c-btn-bold">EXPLORE</button>
                            ...
                            <div class="tab-pane fade" id="c-tab3-3">
                                <div class="col-md-5 col-sm-12">
                                    <ul class="c-items">
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-gamepad"></i>Gaming Stream Trends</h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-crosshairs"></i>How-to optimize your code </h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore. Lorem ipsum dolor sit amet, amet et cosectetuer sed et nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-camera"></i>Photography Tips</h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore. Lorem ipsum dolor sit amet, amet et cosectetuer sed et nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                    </ul>
                                    <button class="btn btn-lg c-theme-btn c-btn-square c-btn-bold">EXPLORE</button>
                            ...
                            <div class="tab-pane fade" id="c-tab3-4">
                                <div class="col-md-5 col-sm-12">
                                    <ul class="c-items">
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-comment-o"></i>Quick Response</h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-file-code-o"></i>Superb Clean Coding</h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore. Lorem ipsum dolor sit amet, amet et cosectetuer sed et nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                        <li>
                                            <h4 class="c-font-20">
                                                <i class="fa fa-dollar"></i>Value for Money </h4>
                                            <p>Lorem ipsum dolor sit amet, amet et cosectetuer sed et nonummy nib dias amet ut ed laoreet dolore. Lorem ipsum dolor sit amet, amet et cosectetuer sed et nib dias amet ut ed laoreet dolore.</p>
                                        </li>
                                    </ul>
                                    <button class="btn btn-lg c-theme-btn c-btn-square c-btn-bold">EXPLORE</button>
                    ...
                    <div class="col-md-3 c-sm-hidden">
                        <div class="c-content c-column-odd c-padding-adjustment">
                            ...
                            @foreach($features as $features_item)
                                <div class="c-row c-title c-font-17">{{$features_item}}</div>
                            @endforeach
                        </div>
                    </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="c-content @if($course_subscription_id%2 == 0) c-column-odd @else c-column-even @endif c-padding-adjustment">
                                ...
                                @foreach($feature_detail_item as $course_feature_id => $course_feature_detail)
                                    ...
                                    @if(!is_array($course_feature_detail))
                                        @continue
                                    @endif

                                    <div class="c-row c-font-17">

                                        @if($course_feature_detail['quantity'] == -5)
                                            <i class="fa fa-check c-font-20"></i>
                                        @elseif($course_feature_detail['quantity'] == 0)
                                            <i class="fa fa-times c-font-20"></i>
                                        @elseif($course_feature_detail['quantity'] == -10)
                                            Unlimited
                                        @else
                                            {{$course_feature_detail['quantity']}}
                                        @endif
                                    </div>
                                @endforeach
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="c-links c-theme-ul">
                            <li>
                                <a href="#">About letshomestudy.com</a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <p class="c-address c-font-16">7, Jalan Sri Klebang 17, Bandar Baru Sri Klebang,
                            ...
                            <br/> Fax: 800 123 3456
                            <br/> Email:
                            <a href="mailto:info@letshomestudy.com.com">
                                <span class="c-theme-color">info@letshomestudy.com.com</span>
                            </a>
                            <br/> Skype:
                            <a href="#">
                                <span class="c-theme-color">letshomestudy.com</span>
                            </a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-md-7">
                        <div class="c-content-title-1 c-title-md">
                            <h3 class="c-font-uppercase c-font-bold">About
                                <span class="c-theme-font">letshomestudy.com</span>
                            </h3>
                            <div class="c-line-left hide"></div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 c-col">
                    <p class="c-copyright c-font-grey">2017 &copy; letshomestudy.com
